/*
* SEPARA Y CORRE 1.0
* JUEGO DESARROLLADO EN INTELLIJ IDEA PARA FOMENTAR EL RECICLAJE DE RESIDUOS.
* AUTORES: 
    BAÑUELOS DE LA TORRE RICARDO
    LEYVA AYALA GENESIS MARIA
    LUNA MARTINEZ LUIS ALEJANDRO
    RODRIGUEZ MUNOZ JOSE LUIS
